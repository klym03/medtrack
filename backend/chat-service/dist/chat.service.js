...
let ChatService = ChatService_1 = class ChatService {
    ...
    constructor(configService) {
        ...
        this.modelName = this.configService.get('OPENAI_MODEL_NAME', 'gpt-4o');
        if (!apiKey) {
            this.logger.error('OPENAI_API_KEY is not configured.');
            throw new common_1.InternalServerErrorException('OpenAI API key is not configured.');
        }
    ...
    async getChatResponse(messages) {
        ...
        try {
            ...
            if (!assistantResponse) {
                ...
                throw new common_1.InternalServerErrorException('Не вдалося отримати відповідь від AI.');
            }
            ...
            throw new common_1.InternalServerErrorException('Помилка при спілкуванні з AI сервісом.');
        }
    }
};
